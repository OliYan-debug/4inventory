  ...
  return (
    <>
      <li
        ...
        className="group/item relative flex cursor-pointer justify-center font-medium transition hover:bg-neutral-500 hover:font-bold data-[active=true]:bg-neutral-600 data-[active=true]:font-bold data-[open=true]:bg-neutral-500 md:rounded-s-lg"
      >
        {/* Desktop Button*/}
        <button
          onClick={() => {
        ...
        >
          <span
            data-active={activeLink}
            className="mt-auto h-1 w-6 rounded-md bg-neutral-50 opacity-0 group-hover:opacity-100 data-[active=true]:opacity-100 md:me-4 md:h-6 md:w-1"
          ></span>
