...
export function MobileSubmenu({
  ...
  return (
    <div
      ref={ref}
      data-isOpen={open}
      className={`absolute bottom-14 z-20 block w-full rounded-t-lg bg-neutral-500 pt-4 pb-2 shadow-lg transition-[opacity] duration-150 ease-in data-[isOpen=false]:invisible data-[isOpen=false]:opacity-0 data-[isOpen=true]:visible data-[isOpen=true]:opacity-100 md:hidden`}
    >
      <button
