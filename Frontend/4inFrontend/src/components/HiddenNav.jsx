...
export default function HiddenNav() {
  return (
    <>
      <ul className="mt-4 flex w-full flex-col py-4">
        <li className="group/item flex cursor-pointer rounded-lg py-4 font-medium transition hover:bg-neutral-500 hover:font-bold">
          <span className="me-4 h-6 w-1 rounded-md bg-neutral-50 opacity-0 group-hover/item:opacity-100"></span>
          <Link to={`products`}>
        ...
        {/* Products group */}
        <li className="group/item relative flex cursor-pointer rounded-s-lg py-4 font-medium transition hover:bg-neutral-500 hover:font-bold">
          <span className="me-4 h-6 w-1 rounded-md bg-neutral-50 opacity-0 group-hover/item:opacity-100"></span>
          <Link to={`products`} className="flex w-full items-center">
            ...
            <ChevronRight
              size={14}
              color="#fafafa"
              className="ms-auto transition-all group-hover/item:translate-x-1"
            />
          </Link>
