...
export function InputRemove({
  ...
  const { t } = useTranslation("input_remove");
      ...
      <div className="flex gap-2">
        <Controller
          ...
          rules={{
            ...
            validate: (value) =>
              value <= selectedItem.quantity || t("quantity_higher"),
          }}
          render={({ field }) => (
            <div className="w-full">
              <InputRoot
        ...
        <div className="flex h-10 w-full gap-1 md:w-1/3">
          <QuantityIncrementDecrement
            ...
            disable={isSubmitting || selectedItem.length <= 0}
            disablePlusBtn={watch("quantity") >= selectedItem.quantity}
          />
        </div>
      </div>
