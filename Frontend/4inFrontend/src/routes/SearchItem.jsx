...
import { ChevronRight, ListRestart, LucidePackageSearch } from "lucide-react"
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="max-w-full min-h-screen p-4 bg-neutral-50 rounded-2xl">
        ...
        >
          ...
          <button
            type="submit"
            className="w-2/5 mt-10 py-2 rounded-lg bg-sky-400 text-neutral-50 font-semibold flex items-center justify-center px-4 hover:bg-sky-500 transition"
          >
